...
<head>
    ...
    <!-- Country Select Css -->
    <link rel="stylesheet" href="{{asset('web-assets')}}/assets/css/niceCountryInput.css">
    <link rel="stylesheet" href="{{asset('web-assets')}}/assets/css/jsuites.css">
    <!-- Fancy box Css -->
...
<section class="loginForm">
    <div class="loginForm__flex">
                    ...
                    <form action="{{ route('login') }}" method="POST" class="custom_form">
                        ...
                        <div class="single_input">
                            ...
                            <div class="include_icon">
                                <input class="form--control radius-5" type="email" name="email" placeholder="Enter your email address" required autofocus>
                        ...
                        <div class="single_input">
                            ...
                            <div class="include_icon">
                                <input class="form--control radius-5" type="password" name="password" placeholder="Enter your password" required>
                        ...
                        <div class="btn-wrapper mt-4">
                            <p class="loginForm__wrapper__signup">
                                ...
                                <a href="{{ route('register') }}" class="loginForm__wrapper__signup__btn">Sign Up</a>
                            </p>
                            ...
                            <div class="loginForm__wrapper__another d-flex flex-column gap-2 mt-3">
                                <a href="javascript:void(0)" class="loginForm__wrapper__another__btn radius-5 w-100">
                                    <img src="{{ asset('web-assets/assets/img/icon/googleIocn.svg') }}" alt="" class="icon"> Login With Google
                                </a>
                                <a href="javascript:void(0)" class="loginForm__wrapper__another__btn radius-5 w-100">
                                    <img src="{{ asset('web-assets/assets/img/icon/fbIcon.svg') }}" alt="" class="icon"> Login With Facebook
                                </a>
                            </div>
                        </div>
                    </form>
        ...
        <div class="loginForm__right loginForm__bg " style="background-image: url({{asset('web-assets')}}/assets/img/login.jpg);">
            <div class="loginForm__right__logo">
                <div class="loginForm__logo">
                    <a href="index.html"><img src="{{asset('web-assets')}}/assets/img/logo.webp" alt=""></a>
                </div>
            </div>
        </div>
    </div>
...
<!-- jquery -->
<script src="{{asset('web-assets')}}/assets/js/jquery-3.6.4.min.js"></script>
<!-- jquery Migrate -->
<script src="{{asset('web-assets')}}/assets/js/jquery-migrate-3.4.1.min.js"></script>
<!-- bootstrap -->
...
<!-- Country Select Js -->
<script src="{{asset('web-assets')}}/assets/js/niceCountryInput.js"></script>
<!-- Multiple Country Select Js -->
<script src="{{asset('web-assets')}}/assets/js/jsuites.js"></script>
<!-- Fancy box Js -->
